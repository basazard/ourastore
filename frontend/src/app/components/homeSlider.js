  ...
  return (
    <div className="flex px-20 py-8">
      <div className="relative group"> 
        ...
        />
        <button className="bg-muted/50 rounded-full py-3 px-1 absolute left-2 top-1/2 -translate-y-1/2 hidden group-hover:block" 
        onClick={() => prevSlide()}>
        ...
        <button className="bg-muted/50 rounded-full py-3 px-1 absolute right-2 top-1/2 -translate-y-1/2 hidden group-hover:block" 
        onClick={() => nextSlide()}>
