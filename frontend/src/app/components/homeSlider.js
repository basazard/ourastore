  ...
  return (
    <div className="flex px-4 sm:px-20 py-8">
      <div className="relative group">
        ...
        />
        <button
          className="bg-muted/50 rounded-full py-3 px-1 absolute left-2 top-1/2 -translate-y-1/2 hidden group-hover:block"
          onClick={() => prevSlide()}
        >
          <svg
        ...
        <button
          className="bg-muted/50 rounded-full py-3 px-1 absolute right-2 top-1/2 -translate-y-1/2 hidden group-hover:block"
          onClick={() => nextSlide()}
        >
          <svg
            className="text-white h-3 w-3 sm:h-5 sm:w-5"
