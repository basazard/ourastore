export function HomeIcon() {
  return (
    <>
      <svg
        className="h-5 w-5 text-white group-hover:text-primary"
...
export function HamburgerIcon({ handler }) {
  return (
    <>
      <button onClick={handler}>
        <svg
          className="h-5 w-5 text-white group-hover:text-primary sm:hidden flex"
          xmlns="http://www.w3.org/2000/svg"
          height="24px"
          viewBox="0 0 24 24"
          width="24px"
...
export function CrossIcon({ handler }) {
  return (
    <>
      <button onClick={handler}>
        <svg
...
export function HomeDropdownIcon() {
  return (
    <>
      <svg
        className="h-4 w-4 text-white"
